...
describe('Component: Angular2Csv', function () {
    ...
    it('should return correct order', function () {
        var component = new ngx_csv_1.ngxCsv([{ name: 'test', age: 20 }], 'My Report', { useBom: false });
    ...
    it('should return csv with title', function () {
        var component = new ngx_csv_1.ngxCsv([{ name: 'test', age: 20 }], 'My Report', { showTitle: true, useBom: false });
        var csv = component['csv'];
    ...
    it('should return csv file with custom field separator', function () {
        var component = new ngx_csv_1.ngxCsv([{ name: 'test', age: 20 }], 'My Report', { useBom: false, fieldSeparator: ';' });
        var csv = component['csv'];
        var first_row = csv.split(ngx_csv_1.CsvConfigConsts.EOL)[0];
        expect(first_row.split(';').length).toBe(2);
    });
    it('should return csv file with custom field separator', function () {
        var component = new ngx_csv_1.ngxCsv([{ name: 'test', age: 20 }], 'My Report', { useBom: false, quoteStrings: '|' });
        var csv = component['csv'];
